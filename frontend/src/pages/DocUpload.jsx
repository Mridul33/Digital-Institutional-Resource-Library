  ...
  return (
    <div className="flex flex-col items-center p-4 mb-10">
      ...
      <button
        ...
        className="bg-blue-600 text-white px-6 py-2 rounded-lg hover:scale-105 hover:shadow-lg hover:bg-blue-700 transition"
      >
        ...
        <div className="mt-4 p-4 bg-gray-100 rounded-lg shadow-md w-full max-w-md">
          ...
          <select
            ...
            onChange={(e) => {
              ...
              const categoryCode = selectedValue.split("__")[0];
          ...
          >
            ...
            {allCategories.map((item) => (
              <option value={`${item.code}__${item.id}`} key={item.id}>
                {item.name}
              </option>
            ))}
          </select>
